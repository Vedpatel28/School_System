                  ...
                  onFieldSubmitted: (value) {
                    if (formkey2.currentState!.validate()) {
                      ...
                      allGlobalvar.alldetail.add(
                        detail(
                            name: allGlobalvar.name, id: allGlobalvar.id, standard: allGlobalvar.standard, classof: allGlobalvar.classof),
                      );
                      allGlobalvar.totalmarcks =
                          (allGlobalvar.name! + allGlobalvar.standard! + allGlobalvar.id! + allGlobalvar.classof!) as int;
